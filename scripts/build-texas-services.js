...
function generate5Signs(serviceSlug, serviceName, cityName, zip) {
  const signsByService = {
    'drain-cleaning': [
      {
        ...
        desc: `Water standing in tub or sink basins indicates progressive buildup of hair, soap scum, and hard limestone scale clinging to interior pipe walls in your ${cityName} home.`
      },
      {
        num: '02',
      ...
      },
      {
        ...
        desc: `Foul sulfur or sewer gas odors escaping floor drains in ${zip} point to decomposing organic matter trapped in secondary branch lines or compromised vent stacks.`
      },
      {
        num: '05 • Emergency',
        urgent: true,
        ...
        desc: `When using the kitchen sink forces dirty water up into a shower drain, your main building drain is fully blocked and requires immediate 24/7 emergency dispatch across ${cityName}.`
      }
    ],
    'burst-pipe-repair': [
      {
        ...
        desc: `A dramatic, unexplained drop in tap pressure across multiple faucets in ${zip} indicates an active high-volume breach or rupture along your main supply lines.`
      },
      {
        num: '02',
        icon: 'fa-snowflake',
        title: 'Rapid Freeze Swings & Attic Pipe Ruptures',
        desc: `Sudden Texas winter cold fronts cause exposed pipes in unheated attics, exterior walls, or crawlspaces to freeze solid. Once ice thaws, split copper or PEX lines burst immediately.`
      },
      {
        num: '03',
        icon: 'fa-water',
        title: 'Water Stains on Drywall or Ceilings',
        desc: `Dark bubbling damp spots, soft drywall, or water dripping through light fixtures reveal concealed pressurized pipe splits inside wall cavities in ${cityName}.`
      },
      {
        num: '04',
        icon: 'fa-volume-high',
      ...
      },
      {
        ...
        urgent: true,
        icon: 'fa-triangle-exclamation',
        title: 'Uncontrolled Interior Flooding',
        desc: `Pressurized supply line ruptures can dump hundreds of gallons an hour into finished living areas. Shut off the main valve and call our 24/7 emergency line immediately.`
      }
    ],
    'water-heater-repair': [
      {
      ...
      },
      {
        ...
        desc: `Heavy mineral content and calcium hardness in ${cityName} water settle to the tank bottom. Water trapped beneath this dense sediment crust boils loudly and overheats the tank bottom.`
      },
      {
        num: '03',
        icon: 'fa-faucet',
      ...
      },
      {
        ...
        desc: `Puddling water around your tank in ${zip} indicates failing inlet nipples, a leaking temperature-pressure relief (TPR) valve, or internal tank fracture.`
      },
      {
        num: '05 • Emergency',
        urgent: true,
    ...
    'sewer-line-repair': [
      {
        ...
        desc: `Recurring backups in lowest-level toilets or laundry standpipes across ${cityName} point to deep structural sewer pipe issues rather than simple fixture clogs.`
      },
      {
        num: '02',
        icon: 'fa-tree',
        title: 'Tree Root Infiltration',
        desc: `Mature root systems from neighborhood oak, pecan, or elm trees seek moisture through hairline joints in older clay or cast-iron lines, creating dense structural mats.`
      },
      {
        num: '03',
        icon: 'fa-layer-group',
        title: 'Expansive Clay Soil Heave & Pipe Bellies',
        desc: `Expansive Texas clay soil shifts dramatically between rainy seasons and summer droughts, causing underground sewer pipes to sag (belly) and snag solids.`
      },
      {
        num: '04',
        icon: 'fa-plant-wilt',
        title: 'Soggy, Sunken Yard Patches',
        desc: `Unusually lush green patches, foul odors, or localized soil sinkholes in your yard indicate a collapsed or separated sewer lateral discharging sewage below lawn grade in ${zip}.`
      },
      {
        num: '05 • Emergency',
        urgent: true,
    ...
    'emergency-plumbing': [
      {
        ...
        desc: `Uncontrolled water escaping from split supply lines, fractured valves, or failed washing machine hoses in ${zip} threatens electrical and structural safety.`
      },
      {
        num: '02',
        icon: 'fa-biohazard',
      ...
      },
      {
        ...
        desc: `A pungent rotten-egg mercaptan smell near water heaters or furnaces in ${cityName} signals an active natural gas leak demanding emergency evacuation and repair.`
      },
      {
        num: '04',
        icon: 'fa-snowflake',
        title: 'Attic & Exterior Pipe Freeze Blowouts',
        desc: `Uninsulated pipes in attics or exterior walls during winter cold snaps can rupture violently as air warms. Emergency isolation prevents severe interior flooding.`
      },
      {
        num: '05 • Emergency',
        urgent: true,
    ...
    'leak-detection': [
      ...
      },
      {
        ...
        desc: `In slab-on-grade homes across ${cityName}, noticeable warm patches on hardwood or tile floors indicate an eroding hot water copper supply line buried in concrete.`
      },
      {
        num: '04',
        icon: 'fa-water',
        title: 'Damp Baseboards & Musty Odors',
        desc: `Persistent moisture under baseboards, peeling flooring, or musty mildew smells point to concealed water vapor migrating from a foundation slab crack.`
      },
      {
        num: '05 • Emergency',
        urgent: true,
        ...
        desc: `Unchecked underground water leaks wash away support soils and trigger rapid clay soil swelling, causing severe foundation fractures and structural shifting.`
      }
    ],
    'gas-line-repair': [
      {
        ...
        desc: `Natural gas is naturally odorless; utilities add sulfurous mercaptan so leaks can be detected. If you smell rotten eggs anywhere in your ${zip} home, act immediately.`
      },
      {
        num: '02',
        icon: 'fa-volume-high',
      ...
      },
      {
        ...
        desc: `Patches of dead or yellowed grass directly over an underground gas service line in ${cityName} reveal gas saturating root zones and displacing oxygen.`
      },
      {
        num: '04',
    ...
    'water-line-repair': [
      ...
      },
      {
        ...
        desc: `Spongy, marshy spots on your front yard between the water meter pit and your house foundation in ${zip} indicate an active underground water main rupture.`
      },
      {
        num: '04',
        icon: 'fa-faucet',
      ...
      },
      {
        ...
        desc: `Water line leaks erode subsurface gravel and subsoil over time, causing driveways, sidewalks, and porch slabs in ${cityName} to settle, crack, or collapse.`
      }
    ]
  };
  ...
  return `
    <section class="signs-section" style="margin-bottom: 38px;">
      ...
      <h2 style="font-size: 1.85rem; font-weight: 800; color: #fff; margin-bottom: 12px;">5 Signs You Need ${serviceName} in ${cityName}, TX (${zip})</h2>
      <p style="color: var(--text-muted); font-size: 1.05rem; line-height: 1.7; margin-bottom: 24px;">Don't wait for minor issues to escalate into severe structural water or gas damage. Contact our ${cityName} dispatch desk if you identify any of these 5 warning signs:</p>
...
function generateLocalContent(serviceSlug, serviceName, cityName, zip) {
  const localCopy = {
    'drain-cleaning': {
      p1Title: `High-Mineral Limestone Scale & Grease Solidification in ${cityName}`,
      p1: `Municipal and regional water sources across ${cityName} carry moderate to heavy dissolved calcium and magnesium minerals. When combined with household cooking oils, soaps, and organic residue, this limestone content calcifies inside residential drains, constricting water flow. Our network contractors utilize commercial-grade electric snake rooters and 4,000 PSI hydro-jetting to blast lines spotless without harsh chemical acids.`,
      p2Title: `Video Camera Inspection & Expansive Texas Clay Diagnostics`,
      p2: `Because homes in ${cityName} (${zip}) are built over expansive clay soils that heave in wet weather and contract during summer heat, underground drain lines frequently develop pipe bellies or offset joints. Matched plumbing technicians run high-resolution CCTV sewer cameras with digital locators down your lateral line to verify whether your stoppage is caused by grease, tree root intrusion, or soil shear fractures before hydro-jetting clean.`
    },
    'burst-pipe-repair': {
      p1Title: `Sudden Winter Freeze Swings & Attic Pipe Ruptures in ${cityName}`,
      p1: `Rapid Texas winter cold fronts subject homes in ${cityName} (${zip}) to sudden sub-freezing temperatures that catch residential plumbing unawares. Uninsulated pipes in attics, exterior walls, and crawlspaces freeze rapidly. Water expansion inside rigid copper lines creates thousands of pounds of hydrostatic pressure, resulting in violent splits once the thaw begins.`,
      p2Title: `Freeze-Resistant PEX-A Expansion Piping & Emergency Line Isolation`,
      p2: `Network plumbers dispatched to ${zip} quickly isolate failed supply manifolds, excise ruptured pipe segments, and replace them with high-ductility PEX-A expansion piping or type-L copper with frost-free sillcocks. Every repair undergoes rigorous hydrostatic pressure testing to verify code compliance under Texas State Board of Plumbing Examiners standards.`
    },
    'water-heater-repair': {
      p1Title: `Hard Water Mineral Scaling & Heating Element Stress in ${cityName}`,
      p1: `High calcium hardness in ${cityName} (${zip}) water creates heavy sediment crusting along the bottom of tank water heaters and inside tankless heat exchangers. This mineral buildup causes popping noises, burner flameouts, lukewarm water, and premature tank corrosion throughout residential water heating systems.`,
      p2Title: `Thermal Expansion Tanks, Relief Valves & Code-Compliant Installs`,
      p2: `Texas plumbing codes require thermal expansion tanks on closed water systems. In ${cityName}, network technicians calibrate expansion tanks to exact municipal street pressure, inspect temperature-pressure relief (TPR) valves, flush mineral sediment, and install high-efficiency Rheem, Bradford White, and tankless units built for long service life.`
    },
    'sewer-line-repair': {
      p1Title: `Expansive Texas Clay Soil Shifting & Pipe Bellies in ${cityName}`,
      p1: `Properties in ${cityName} (${zip}) sit over expansive clay soils that expand significantly when saturated with rain and shrink during severe summer droughts. This repeated ground movement exerts immense vertical and lateral pressure on underground sewer laterals, creating low sags (bellies), cracked joints, and offset pipes that snag household waste.`,
      p2Title: `Trenchless CIPP Epoxy Relining & Minimal Yard Excavation in ${zip}`,
      p2: `Rather than digging up driveways and manicured landscaping in ${cityName}, network sewer specialists deploy trenchless cured-in-place pipe (CIPP) relining. By inserting an epoxy-saturated sleeve that cures into a seamless, jointless pipe inside the old host line, homeowners receive a smooth root-proof lateral with up to 50-year structural life.`
    },
    'emergency-plumbing': {
      p1Title: `24/7 Rapid Priority Dispatch for Critical Failures in ${cityName} (${zip})`,
      p1: `Plumbing catastrophes don't keep business hours. Whether an uncontained burst pipe is flooding a home in ${cityName}, a main sewer line is backing up blackwater, or a water heater has ruptured, Home Plumbing USA coordinates 24/7 on-call dispatch with local licensed contractors across ${zip}.`,
    ...
    'leak-detection': {
      ...
      p1: `Slab-on-grade foundation construction across ${cityName} frequently conceals copper pipe pinhole leaks caused by aggressive soil minerals, ground shifting, and thermal friction. Homeowners often notice unexplained spikes in water bills, hot floor spots, or musty foundation humidity before water surfaces visually.`,
    ...
    'gas-line-repair': {
      p1Title: `Certified Gas Pressure Testing & Mercaptan Leak Location in ${cityName}`,
      p1: `Natural gas leaks present acute safety risks. In ${cityName} (${zip}), aging black iron lines, ground shifting in clay soils, and corroded appliance flex connectors can develop leaks. Mercaptan rotten-egg smells or hissing lines near furnaces require immediate evacuation and licensed repair.`,
      p2Title: `Code Compliance, Heavy-Duty Black Iron Piping & Municipal Sign-Off`,
      p2: `Licensed gas fitters in our network use digital combustible gas sniffers, replace deteriorated piping with heavy-duty black iron or CSST, perform digital manometer pressure drop tests, and ensure full compliance with Texas Railroad Commission and local municipal safety inspection standards.`
    },
    'water-line-repair': {
      p1Title: `Main Water Service Line Replacements in ${cityName} (${zip})`,
      p1: `The underground water service line connecting the municipal water meter to your home in ${cityName} operates under continuous street pressure. Over decades, soil shifting, aggressive minerals, and ground movement cause copper or legacy galvanized lines to corrode, rupture, or leak underground.`,
...
function generateFAQs(serviceSlug, serviceName, cityName, zip) {
  ...
  faqs.push({
    q: `Are the technicians dispatched to ${cityName} (${zip}) licensed and insured in Texas?`,
    a: `Yes. Every contractor in our network is fully vetted, holds active licensure in good standing with the Texas State Board of Plumbing Examiners (TSBPE), and carries comprehensive commercial general liability insurance.`
  });

  faqs.push({
    q: `How do expansive clay soils in ${cityName} affect my underground plumbing?`,
    a: `Expansive clay soils prevalent throughout Texas expand significantly when saturated with rain and shrink during summer dry spells. This cyclical soil movement frequently causes sewer bellies, joint separation, slab stress, and underground water line ruptures.`
  });
  ...
  faqs.push({
    ...
    a: `Yes. Water supplied in ${zip} carries dissolved calcium and magnesium minerals. Over time, these minerals precipitate out, coating heating elements, clogging aerators, and constricting pipe diameters, which our plumbers clean, descale, or flush.`
  });
  ...
  if (serviceSlug === 'drain-cleaning') {
    ...
    faqs.push({
      q: `Why do drains in ${cityName} clog more frequently during extreme heat?`,
      a: `High summer temperatures cause underground grease and fats to bake onto pipe walls while low rainfall reduces municipal gravity flush rates, leading to sticky residue buildup in residential branch drains.`
    });
    faqs.push({
    ...
    faqs.push({
      ...
      a: `Many Texas homes route water lines through unheated attic spaces. When temperatures drop below freezing for several hours, water inside exposed pipes freezes and expands, fracturing copper or CPVC lines that burst once temperatures rise.`
    });
    faqs.push({
      q: `What replacement pipe materials are recommended for burst pipe repairs in ${cityName}?`,
      a: `Our network technicians install high-ductility PEX-A expansion tubing or heavy-gauge Type L copper. PEX-A is highly resistant to freeze expansion and resists corrosion from Texas mineral water.`
    });
    faqs.push({
      q: `Does homeowner's insurance typically cover burst pipe repairs in Texas?`,
      a: `Most homeowner policies cover sudden and accidental water damage caused by burst pipes. Matched contractors provide detailed diagnostic invoices and photographic documentation to assist your insurance claim process.`
    });
  } else if (serviceSlug === 'water-heater-repair') {
    faqs.push({
      q: `How long do water heaters typically last in ${cityName}?`,
      a: `Due to mineral scale and hard water in Texas, standard tank water heaters typically last 8 to 12 years. Regular annual tank flushing and anode rod replacement can extend operational life significantly.`
    });
    faqs.push({
    ...
    faqs.push({
      q: `Are tankless water heaters suitable for homes in ${cityName}?`,
      a: `Yes. Tankless water heaters provide endless on-demand hot water and occupy minimal space. However, because of hard water scale, they require an annual vinegar descaling flush or an inline water conditioner.`
    });
    faqs.push({
    ...
    faqs.push({
      ...
      a: `Trenchless CIPP relining requires zero digging through driveways, sidewalks, or mature landscaping. It creates a seamless, jointless epoxy pipe inside the old line that blocks root intrusion and lasts up to 50 years.`
    });
    faqs.push({
      q: `How do tree roots enter underground sewer pipes in ${cityName}?`,
      a: `Microscopic moisture vapor escapes through older clay pipe joints or tiny cracks. Hairline tree roots seek this moisture, enter the joint, and feed on wastewater nutrients, rapidly expanding into massive flow-blocking root balls.`
    });
    faqs.push({
    ...
    faqs.push({
      q: `Who is responsible for the sewer line connecting my house to the street in Texas?`,
    ...
    faqs.push({
      q: `What repair options exist for slab leaks in Texas homes?`,
    ...
    faqs.push({
      ...
      a: `Yes. Licensed Master and Journeyman plumbers under the Texas State Board of Plumbing Examiners are certified to test, repair, and install natural gas and propane supply piping.`
    });
    faqs.push({
    ...
    faqs.push({
      ...
      a: `Common signs include soggy or unusually green patches on your lawn between the meter and foundation, low household water pressure, cloudy tap water, and a continuously spinning water meter.`
    });
    faqs.push({
    ...
    faqs.push({
      q: `What pipe materials are used for new water service lines in Texas?`,
      a: `Plumbers install heavy-gauge seamless Type K copper or 200 PSI certified High-Density Polyethylene (HDPE), both of which resist corrosive Texas soils and ground shifting.`
    });
  }
...
function buildServicePage(loc, service, nearbyList) {
  ...
  const pageUrl = `https://homeplumbingusa.com/texas/${cityZipSlug}/${serviceSlug}/`;
  const hubUrl = `https://homeplumbingusa.com/texas/${cityZipSlug}/`;
  ...
  const otherServicesHtml = SERVICES.filter(s => s.slug !== serviceSlug).map(s => `
    <a href="/texas/${cityZipSlug}/${s.slug}/" class="list-link" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 14px; border-radius: var(--radius-sm); border: 1px solid var(--border-color); margin-bottom: 8px; font-size: 0.92rem; color: var(--text-muted); text-decoration: none; transition: var(--transition);">
  ...
  const nearbyHtml = (nearbyList && nearbyList.length > 0 ? nearbyList : []).slice(0, 9).map(nb => {
    ...
    return `
    <a href="/texas/${nbSlug}/${serviceSlug}/" class="list-link" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 14px; border-radius: var(--radius-sm); border: 1px solid var(--border-color); margin-bottom: 8px; font-size: 0.92rem; color: var(--text-muted); text-decoration: none; transition: var(--transition);">
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": "Texas",
            "item": "https://homeplumbingusa.com/state/texas/"
          },
          {
            "@type": "ListItem",
            "position": 3,
...
<head>
  ...
  <meta name="keywords" content="${serviceName.toLowerCase()} ${cityName} TX, ${serviceName.toLowerCase()} ${zip}, emergency plumber ${cityName}, 24/7 plumbing repair ${cityName} TX">
  ...
  <header class="header" id="header" style="min-height: 120px;">
    ...
    <div class="header-inner container" style="min-height: 80px; height: 80px; display: flex; align-items: center; justify-content: space-between;">
      ...
      <nav class="nav" id="mainNav">
        ...
        <a href="${stateUrl}" class="nav-link">Texas</a>
    ...
    <section class="hero" style="padding: 60px 0 45px; background: linear-gradient(135deg, rgba(10, 22, 40, 0.96), rgba(15, 30, 60, 0.88)); color: var(--text-white); position: relative;">
      <div class="container">
        <div class="breadcrumbs" style="display: flex; gap: 8px; align-items: center; font-size: 0.9rem; margin-bottom: 24px; color: var(--text-muted); flex-wrap: wrap;">
          ...
          <a href="${stateUrl}" style="color: var(--primary-light); text-decoration: none;">Texas</a>
          <i class="fas fa-chevron-right" style="font-size: 0.75rem;"></i>
        ...
        <div class="grid-2 hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 3rem; align-items: center;">
          <div class="hero-content">
            ...
            <h1 style="font-size: 2.75rem; line-height: 1.2; color: #fff; margin-bottom: 1.25rem; font-weight: 800;">
              ${serviceName} in <span style="color: var(--accent);">${cityName}, TX (${zip})</span>
            </h1>
        ...
        <div class="quick-info-grid">
          ...
          <div class="quick-info-card">
            ...
            <div class="quick-info-text">
              ...
              <span class="quick-info-sub">Active Texas Coverage</span>
            </div>
          </div>
        ...
        <div class="detail-layout">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-step">
                ...
                <div>
                  ...
                  <p>The licensed technician arrives on-site in ${cityName} with a fully-equipped service vehicle to inspect pipe conditions, pressures, and local soil movement.</p>
                </div>
              </div>
              <div class="workflow-step">
              ...
              <div class="workflow-step">
                ...
                <div>
                  ...
                  <p>Work is carried out using commercial-grade materials compliant with Texas State Board of Plumbing Examiners (TSBPE) regulations and municipal codes.</p>
                </div>
              </div>
              <div class="workflow-step">
          ...
          <div class="detail-sidebar">
            ...
            <div class="sidebar-widget">
              ...
              <p style="font-size: 0.9rem; color: var(--text-muted); line-height: 1.6; margin-bottom: 12px;">Explore full Texas state coverage and statewide plumbing directory.</p>
              <a href="${stateUrl}" style="color: var(--primary-light); font-weight: 700; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; font-size: 0.92rem;">
                View Texas Directory <i class="fas fa-arrow-right" style="font-size: 0.8rem;"></i>
              </a>
            </div>
          </div>
        </div>
      ...
      <div style="display: grid; grid-template-columns: 1.5fr 1fr 1fr 1.2fr; gap: 3rem; margin-bottom: 3rem;">
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.92rem;">
            ...
            <a href="${stateUrl}" style="color: var(--text-muted); text-decoration: none;">Texas Plumbers</a>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.92rem;">
            <a href="/texas/${cityZipSlug}/drain-cleaning/" style="color: var(--text-muted); text-decoration: none;">Drain Cleaning</a>
            <a href="/texas/${cityZipSlug}/burst-pipe-repair/" style="color: var(--text-muted); text-decoration: none;">Burst Pipe Repair</a>
            <a href="/texas/${cityZipSlug}/water-heater-repair/" style="color: var(--text-muted); text-decoration: none;">Water Heater Repair</a>
            <a href="/texas/${cityZipSlug}/sewer-line-repair/" style="color: var(--text-muted); text-decoration: none;">Sewer Line Repair</a>
            <a href="/texas/${cityZipSlug}/emergency-plumbing/" style="color: var(--text-muted); text-decoration: none;">Emergency Plumbing</a>
          </div>
        </div>
...
function main() {
  ...
  txLocations.forEach((loc, index) => {
    ...
    if ((index + 1) % 200 === 0 || index + 1 === txLocations.length) {
