...
function buildServicePage(loc, service, nearbyList) {
  ...
  const metaDesc = `Fast, reliable ${serviceName.toLowerCase()} in ${cityName}, FL (${zip}). Vetted licensed pros, upfront flat-rate pricing & 24/7 emergency dispatch. Call 888-217-4803!`;
  ...
  <header class="header" id="header" style="min-height: 120px;">
    <div class="top-bar" style="min-height: 40px; height: 40px; display: flex; align-items: center; justify-content: center; text-align: center; white-space: nowrap;">
      <div class="top-bar-content">
        ...
        <span>24/7 ${serviceName} in <strong>${cityName}, FL (${zip})</strong> &bull; Vetted Independent Network &bull; <a href="tel:888-217-4803" style="color: inherit; text-decoration: none; font-weight: 700;">888-217-4803</a></span>
      </div>
    </div>
