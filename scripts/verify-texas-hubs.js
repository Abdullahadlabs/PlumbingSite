...
const txLocs = seoData.filter(l => l.state === 'TX');

console.log('Total TX locations in DB:', txLocs.length);
...
console.log('=== Texas Hub Verification Results ===');
...
if (missingCount === 0 && missingSections === 0 && schemaErrors === 0) {
  console.log('ALL 1731 TEXAS CITY/ZIP HUBS ARE 100% HEALTHY & VALID!');
} else {
