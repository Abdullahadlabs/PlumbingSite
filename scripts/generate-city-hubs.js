...
<body data-prefix="/" data-depth="0">
  ...
  <header class="header" id="header" style="min-height: 120px;">
    <div class="top-bar city-top-bar">
      <div class="container top-bar-inner">
        <div class="top-bar-info">
          <span class="pulse-dot"></span>
          <span class="top-bar-text">
            <span class="top-bar-lead">Professional Plumbing Team </span>Available 24/7 in <strong>${cityName}, ${stateCode} (${zip})</strong>
          </span>
        </div>
        <div class="top-bar-cta">
          <a href="tel:877-516-8705" class="top-bar-phone-link">
            <i class="fas fa-phone-alt top-bar-phone-icon"></i>
            <span class="top-bar-phone-label">Emergency Line: </span>(877) 516-8705
          </a>
        </div>
      </div>
    </div>
          ...
          <div class="project-card" style="background: var(--bg-card); border-radius: var(--radius-md); border: 1px solid var(--border-color); overflow: hidden; box-shadow: var(--shadow-sm); display: flex; flex-direction: column;">
            <div class="project-image-wrapper" style="height: 220px; overflow: hidden; position: relative;">
              <picture>
                ...
                <img src="/images/project1-after.png" alt="Water heater replacement in ${cityName}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.onerror=null; if(this.parentElement && this.parentElement.querySelector('source')) this.parentElement.querySelector('source').remove(); this.src='/images/project1-after.png';">
              </picture>
          ...
          <div class="project-card" style="background: var(--bg-card); border-radius: var(--radius-md); border: 1px solid var(--border-color); overflow: hidden; box-shadow: var(--shadow-sm); display: flex; flex-direction: column;">
            <div class="project-image-wrapper" style="height: 220px; overflow: hidden; position: relative;">
              <picture>
                ...
                <img src="/images/project2-after.png" alt="Slab leak detection in ${cityName}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.onerror=null; if(this.parentElement && this.parentElement.querySelector('source')) this.parentElement.querySelector('source').remove(); this.src='/images/project2-after.png';">
              </picture>
              <span style="position: absolute; top: 12px; left: 12px; background: rgba(10,22,40,0.85); color: var(--accent); padding: 4px 10px; border-radius: 4px; font-size: 0.75rem; font-weight: 700; text-transform: uppercase;">Completed</span>
            </div>
            <div class="project-content-block" style="padding: 24px; flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
          ...
          <div class="project-card" style="background: var(--bg-card); border-radius: var(--radius-md); border: 1px solid var(--border-color); overflow: hidden; box-shadow: var(--shadow-sm); display: flex; flex-direction: column;">
            <div class="project-image-wrapper" style="height: 220px; overflow: hidden; position: relative;">
              <picture>
                ...
                <img src="/images/project3-after.png" alt="Drainage refit in ${cityName}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.onerror=null; if(this.parentElement && this.parentElement.querySelector('source')) this.parentElement.querySelector('source').remove(); this.src='/images/project3-after.png';">
              </picture>
              <span style="position: absolute; top: 12px; left: 12px; background: rgba(10,22,40,0.85); color: var(--accent); padding: 4px 10px; border-radius: 4px; font-size: 0.75rem; font-weight: 700; text-transform: uppercase;">Completed</span>
            </div>
            <div class="project-content-block" style="padding: 24px; flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
