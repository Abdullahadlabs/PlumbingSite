...
${isAnchorage ? `<link rel="preload" as="image" href="/public/images/clogged-drain-repair-service-anchorage.webp" fetchpriority="high">` : `<link rel="preload" as="image" href="/public/images/hero-plumbing-mobile.webp" fetchpriority="high" media="(max-width: 600px)">
  ...
  <script>
    (function() {
      ...
      const preloadHeroPath = isMobile ? '/public/images/hero-plumbing-mobile.webp' : '/public/images/hero-plumbing.webp';
      const preloadLink = document.createElement('link');
      preloadLink.rel = 'preload';
      preloadLink.as = 'image';
      preloadLink.href = preloadHeroPath;
  ...
  <!-- Tailwind Play CDN: loaded lazily to eliminate TBT -->
  <script>
    (function() {
              ...
              theme: {
                extend: {
                  colors: {
                    ...
                    orange: { DEFAULT: '#f59e0b', dark: '#d97706' },
                    green: '#2563eb',
                    red: '#e63946'
                  }
                }
      ...
      if (typeof requestIdleCallback !== 'undefined') {
        requestIdleCallback(loadTailwind, { timeout: 5000 });
      } else {
        window.addEventListener('load', function() { setTimeout(loadTailwind, 3000); });
      }
      const triggerEvents = ['scroll', 'mousemove', 'touchstart', 'click'];
      triggerEvents.forEach(function(e) {
        window.addEventListener(e, loadTailwind, { passive: true, once: true });
      });
    })();
  </script>
...
<body data-prefix="../../" data-depth="2">
  ...
  <!-- Header -->
  <header class="header site-header" id="header" style="min-height: 120px;">
...
${isAnchorage ? `    <!-- Hero Section -->
    <section class="hero-section hero-anchorage" id="hero" style="background: linear-gradient(rgba(10, 20, 40, 0.8), rgba(10, 20, 40, 0.9)), url('/public/images/clogged-drain-repair-service-anchorage.webp') center/cover no-repeat !important;">
      <div class="container">
        <div class="hero-grid hero-grid-anchorage" style="display: flex; justify-content: center; width: 100%;">
          <div class="hero-content" style="max-width: 800px; margin: 0 auto; text-align: center;">
            <div class="hero-badge" style="display: inline-flex; margin-bottom: 16px;"><i class="fas fa-star"></i> Serving Local Neighborhoods</div>
      ...
      <div class="container">
        <div class="hero-grid">
          ...
          <div class="hero-image-wrapper" style="position: relative; width: 100%; min-height: 350px; display: flex; justify-content: center;">
            <div class="hero-image-container" style="position: relative; width: 100%; max-width: 420px; aspect-ratio: 4 / 5; min-height: 350px; display: block; background: #0f1e3a; contain: layout style; border-radius: var(--radius-md); overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.3);">
              <img src="/public/images/hero-plumbing.webp" srcset="/public/images/hero-plumbing-mobile.webp 480w, /public/images/hero-plumbing.webp 1200w" sizes="(max-width: 600px) 480px, 1200px" alt="Local Plumbing Services in ${city}" class="hero-image" width="600" height="750" loading="eager" fetchpriority="high" style="width: 100%; height: 100%; aspect-ratio: 4 / 5; object-fit: cover; display: block; filter: brightness(0.95);">
    ...
    <section class="reviews-section section" id="reviews" style="background: var(--bg-darker); padding: 60px 0;">
      <div class="container">
        <div class="section-header animate-on-scroll" style="text-align: center; margin-bottom: 40px;">
          <div class="section-label" style="color: var(--primary-light); font-weight: 700; text-transform: uppercase; letter-spacing: 1px; font-size: 0.85rem; margin-bottom: 8px;">Customer Reviews</div>
          <h2 class="section-title" style="font-size: 2.25rem; font-weight: 800; color: var(--text-white);">Verified Customer Feedback in ${city}, ${stateCode}</h2>
          <p class="section-desc" style="color: var(--text-muted); max-width: 600px; margin: 10px auto 0;">Real experiences from local homeowners matched through our 24/7 plumbing network in ${city}.</p>
        </div>
        <div class="reviews-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px;">
          <div class="review-card animate-on-scroll visible" style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 28px; display: flex; flex-direction: column; justify-content: space-between; transition: var(--transition); box-shadow: var(--shadow-md);">
            <div>
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                <div class="star-rating" style="color: #f59e0b; font-size: 0.95rem;">
                  <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                </div>
                <span style="background: rgba(34, 197, 94, 0.15); color: #4ade80; border: 1px solid rgba(34, 197, 94, 0.3); padding: 2px 10px; border-radius: 12px; font-size: 0.72rem; font-weight: 600;">Verified Customer</span>
              </div>
              <p style="color: var(--text-light); font-size: 0.95rem; line-height: 1.65; margin-bottom: 20px; font-style: italic;">
                "Our main drain backed up on a holiday weekend. Home Plumbing USA connected us with a top local plumber in ${city} who arrived in 40 minutes with a hydro jetting rig and cleared the line completely!"
              </p>
            </div>
            <div>
              <div style="font-weight: 700; color: var(--text-white); font-size: 1rem; margin-bottom: 8px;">Brandon S.</div>
              <div style="display: inline-block; background: rgba(37, 99, 235, 0.12); color: var(--primary-light); border: 1px solid rgba(37, 99, 235, 0.25); padding: 4px 12px; border-radius: 20px; font-size: 0.78rem; font-weight: 600;">
                <i class="fas fa-wrench" style="margin-right: 4px;"></i> Emergency Plumbing | ${city}, ${stateCode}
              </div>
            </div>
          </div>
          ...
          <div class="review-card animate-on-scroll visible" style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 28px; display: flex; flex-direction: column; justify-content: space-between; transition: var(--transition); box-shadow: var(--shadow-md);">
            <div>
              ...
              <p style="color: var(--text-light); font-size: 0.95rem; line-height: 1.65; margin-bottom: 20px; font-style: italic;">
                "Our 50-gallon water heater failed without warning. The technician gave us an upfront flat-rate estimate, safely replaced the unit, and tested all connections. Outstanding craftsmanship in ${city}!"
              </p>
            </div>
            <div>
              <div style="font-weight: 700; color: var(--text-white); font-size: 1rem; margin-bottom: 8px;">Elena R.</div>
              <div style="display: inline-block; background: rgba(37, 99, 235, 0.12); color: var(--primary-light); border: 1px solid rgba(37, 99, 235, 0.25); padding: 4px 12px; border-radius: 20px; font-size: 0.78rem; font-weight: 600;">
                <i class="fas fa-wrench" style="margin-right: 4px;"></i> Water Heater Replacement | ${city}, ${stateCode}
              </div>
            </div>
          </div>
          ...
          <div class="review-card animate-on-scroll visible" style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 28px; display: flex; flex-direction: column; justify-content: space-between; transition: var(--transition); box-shadow: var(--shadow-md);">
            <div>
              ...
              <p style="color: var(--text-light); font-size: 0.95rem; line-height: 1.65; margin-bottom: 20px; font-style: italic;">
                "Had a hidden leak behind our bathroom drywall. The plumber used acoustic sensors to find the exact pinhole leak without tearing up our wall. Fast, professional, and trustworthy!"
              </p>
            </div>
            <div>
              <div style="font-weight: 700; color: var(--text-white); font-size: 1rem; margin-bottom: 8px;">Michael D.</div>
              <div style="display: inline-block; background: rgba(37, 99, 235, 0.12); color: var(--primary-light); border: 1px solid rgba(37, 99, 235, 0.25); padding: 4px 12px; border-radius: 20px; font-size: 0.78rem; font-weight: 600;">
                <i class="fas fa-wrench" style="margin-right: 4px;"></i> Leak Detection & Repair | ${city}, ${stateCode}
              </div>
            </div>
          </div>
        </div>
...
<body>
  ...
  <header class="header" id="header" style="min-height: 80px;">
    <div class="header-inner" style="min-height: 80px; height: 80px; display: flex; align-items: center; justify-content: space-between;">
      <a href="../../../index.html" class="logo" style="min-height: 52px; width: 247px; max-width: 100%; display: flex; align-items: center;">
        <img src="/public/images/logo.svg" alt="Home Plumbing USA Logo" class="logo-img" width="247" height="52" style="width: 247px; height: 52px; aspect-ratio: 247 / 52; display: block; object-fit: contain; object-position: left center;">
      </a>
      <nav class="nav" id="mainNav">
  ...
  <section class="hero hero-sub">
    <div class="container">
      <div class="hero-grid">
        ...
        <div class="hero-image-wrapper" style="position: relative; width: 100%; min-height: 350px; display: flex; justify-content: center;">
          <div class="hero-image-container" style="position: relative; width: 100%; max-width: 420px; aspect-ratio: 4 / 5; min-height: 350px; display: block; background: #0f1e3a; contain: layout style; border-radius: var(--radius-md); overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.3);">
            <img src="/public/images/hero-plumbing.webp" alt="Local ${sub.service_name} in ${city}" class="hero-image" width="600" height="750" loading="eager" fetchpriority="high" style="width: 100%; height: 100%; aspect-ratio: 4 / 5; object-fit: cover; display: block; filter: brightness(0.95);">
            <div class="hero-overlay-badge" style="position: absolute; bottom: 20px; left: 20px; right: 20px; background: rgba(15, 23, 42, 0.9); backdrop-filter: blur(8px); border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius-sm); padding: 16px; display: flex; align-items: center; gap: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.2);">
